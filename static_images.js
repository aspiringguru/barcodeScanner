console.log("static_images.js loading...")
...
$(function() {
    var App = {
        ...
        attachListeners: function() {
            ...
            $(".controls").on("click", "button.next", function(e) {
                console.log("on click button.next")
                e.preventDefault();
                Quagga.start();
            });
    ...
    Quagga.onProcessed(function(result) {
        console.log("Quagga.onProcessed - function(result) ")
        var drawingCtx = Quagga.canvas.ctx.overlay,
            drawingCanvas = Quagga.canvas.dom.overlay;

        if (result) {
            console.log("Quagga.onProcessed - function(result) > result is not null.")
            if (result.boxes) {
    ...
    Quagga.onDetected(function(result) {
        console.log("Quagga.onDetected(function(result)")
        var $node,
...
console.log("static_images.js loaded.")
